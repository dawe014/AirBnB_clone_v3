...
**hbnb** is a full-stack clone of the web application [AirBnB](https://www.airbnb.com/). This clone was built in four iterative phases. 
...
## File Descriptions
  **Note:** Below highlights only new file additions for Phase 3. For file descriptions from previous phases
...
Dawit Tamiru - [Github](https://github.com/dawe014)  
Tsinat Abebaw - [Github](https://github.com/tsinattt)
